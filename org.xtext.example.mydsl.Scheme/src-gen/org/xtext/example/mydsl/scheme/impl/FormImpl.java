 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.scheme.impl.FormImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.scheme.impl.FormImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormImpl extends MinimalEObjectImpl.Container implements Form
{
  ...
  {
    return SchemePackage.Literals.FORM;
  }
  ...
  public EList<Definition> getDefinition()
  {
    if (definition == null)
    {
      definition = new EObjectContainmentEList<Definition>(Definition.class, this, SchemePackage.FORM__DEFINITION);
    }
    return definition;
  }
  ...
  public EList<Expression> getExpression()
  {
    if (expression == null)
    {
      expression = new EObjectContainmentEList<Expression>(Expression.class, this, SchemePackage.FORM__EXPRESSION);
    }
    return expression;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SchemePackage.FORM__DEFINITION:
        return ((InternalEList<?>)getDefinition()).basicRemove(otherEnd, msgs);
      case SchemePackage.FORM__EXPRESSION:
